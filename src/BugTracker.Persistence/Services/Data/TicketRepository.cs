...
namespace BugTracker.Persistence.Services.Data
{
    public class TicketRepository : BaseRepository<Ticket>, ITicketRepository
    {
        ...
        {
            using (var connection = new SqlConnection("Data Source=.\\SQLEXPRESS;Initial Catalog=BugTrackerDb;Integrated Security=True;Encrypt=False"))
            {
                connection.Open();

                using (var command = new SqlCommand("InsertTicket", connection))
                {
                    ...
                    command.Parameters.AddWithValue("@EstimatedAmountOfHours", entity.EstimatedAmountOfHours);
